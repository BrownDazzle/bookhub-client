          ...
          {cartItems?.length === 0 ? <CartEmpty onCartToggle={onCartToggle} /> : <div>
            ...
            <div className="fixed bottom-0 bg-white w-full px-5 py-2 grid items-center">
              <div className="flex items-center justify-between">
                ...
                <h1 className="text-sm rounded bg-theme-cart text-slate-100 px-1 py-0.5">K{totalAmount}</h1>
              </div>
              <div className="grid items-center gap-2 mb-10">
                ...
                <a href="/checkout" className="button-theme bg-theme-cart text-white" onClick={onCartToggle}>Process payment</a>
              </div>
            </div>
